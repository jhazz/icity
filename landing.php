  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">В начало <span class="sr-only">(current)</span></a> </li>
        <li><a href="#">Link</a> </li>
        ...
        <div class="form-group">
          ...
          if(doq\Session::$userId) {
            if(doq\Session::$activePersonFirstName!=''){
              print doq\Session::$activePersonFirstName.'&nbsp;'.doq\Session::$activePersonLastName;
            } else {
              print doq\Session::$login;
            }
          } else {
            print "<a href='login.php'>Вход в систему</a>";
          }
          ?>
        </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div id="carousel1" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item"> <img class="img-responsive" src="images/slide1.jpg" alt="thumb">
              <div class="carousel-caption"> Все что вам нужно вы найдете здесь </div>
            </div>
            <div class="item active"> <img class="img-responsive" src="images/slide2.jpg" alt="thumb">
              <div class="carousel-caption"> Вас ждут </div>
            </div>
