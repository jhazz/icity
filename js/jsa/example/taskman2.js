...
(function(/*require, exports, module*/){
    var defaults={taskPoolCapacity:4, taskPoolCount:3, loopTime:40 /* 40 msec = 1000/25fps */, maxLoopTime:1000},
        C={
        STATE_CREATED:1,
        STATE_WORKING:2,
        STATE_DELAYED:4,
     ...
     * @param {Object} self объект, относительно которого вызывается задача
     ...
     **/
    taskman.TaskPool.prototype.addTask=function(job, execute, value, init, afterDone, afterFail, afterTimeout, timeoutmsec, delaymsec){
        var task;
    ...
    taskman.Worker.prototype.loop=function(poolNo,stopAtTime,startFromLeavePos){
        ...
        while(true){
            ...
            if((task.state&(C.STATE_CREATED|C.STATE_WORKING))==(C.STATE_CREATED|C.STATE_WORKING)){
                if(task.init!==undefined) {
                    task.init(resolved,rejected);
                }
    ...
    taskman.Worker.prototype.async=function(job,plan) {
